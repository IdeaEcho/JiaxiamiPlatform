...
<table class="table">
    <thead>
    <tr>
        <div class="ibox-create">
            <a href="#" class="btn btn-primary" data-toggle="modal" data-target="#myDialog" data-data="add"><i class="glyphicon glyphicon-plus-sign"></i><span>添加菜品分类</span></a>
        </div>
    </tr>
    <tr>
        <th>#</th>
